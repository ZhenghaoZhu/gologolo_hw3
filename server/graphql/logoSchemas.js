    ...
    fields: function () {
        return {
            ...
            updateLogo: {
                ...
                resolve(root, params) {
                    return LogoModel.findByIdAndUpdate(params.id, { text: params.text, color: params.color, fontSize: params.fontSize, backgroundColor: params.backgroundColor, lastUpdate: new Date() }, function (err) {
